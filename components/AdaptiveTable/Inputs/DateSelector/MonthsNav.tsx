...
// import { FaChevronRight, FaChevronLeft } from '@/components/FaIcons/icons';
...
export default function MonthsNav(props: IMonthsNavProps) {
    ...
    return (
        <div className="w-full mt-6.5 absolute top-0 flex flex-row justify-between">
            <button
                className="mx-2 text-gray-200 hover:text-gray-400 cursor-pointer transform hover:scale-110"
                type="button"
