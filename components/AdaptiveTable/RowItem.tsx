...
import {IFieldList, FilterType} from '@/client/pagination/IPagerParams';
...
export default function RowItem(props: IRowItemProps) {
    ...
    const handleSelectOneRow = useCallback(
        (id: string) => {
        ...
        if (editable) {
            switch (type) {
                ...
                case FilterType.DateRange:
                    return (
                        <DateSelector name={field} onChange={handleChange} />
                    );
                ...
                case FilterType.Touche: {
                    ...
                    const checked = get(pager, 'touched')?.includes?.(itemID);
            ...
            return draw ? draw(data, field) : get(data, field);
        }
    }, [
        columns,
        data,
