		...
		<header className="bg-gray-900 sm:flex sm:items-center sm:justify-between xl:bg-white">
			<div className="flex justify-between px-4 py-3 xl:w-72 xl:bg-gray-900 xl:justify-center xl:py-5">
				...
				<button
					...
					className="px-2 text-gray-500 hover:text-white focus:outline-none focus:text-white sm:hidden"
				>
					<svg
...
const navButtonStyle =
	"block px-3 py-1 rounded font-semibold text-white hover:bg-gray-800 sm:text-center sm:text-sm sm:px-2 xl:text-gray-900";
		...
		>
			...
			<div className="sm:flex sm:items-center">
				<div className="px-2 pt-2 pb-5 border-b border-gray-800 sm:flex sm:items-center sm:border-b-0 sm:py-0 sm:px-0">
					...
					<Link href="/test" className={"mt-1 sm:mt-0 " + navButtonStyle}>
						Test
					</Link>
				</div>
				<div className="relative px-5 py-5 sm:py-0 sm:ml-4 sm:px-0">
					...
					<Dropdown
						...
						trigger={
							<span className="block h-8 w-8 overflow-hidden rounded-full border-2 border-white xl:border-indigo-500">
								<img
