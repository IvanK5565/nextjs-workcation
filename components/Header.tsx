...
function Navigation({ isOpen }: { isOpen: boolean }) {
  return <nav className={clsx("sm:flex sm:items-center sm:px-4 xl:flex-1 xl:justify-between", { "hidden": !isOpen }, { "block": isOpen })}>
    <div className="hidden xl:block xl:relative xl:max-w-xs xl:w-full">
      ...
      <input className="block w-full border border-transparent bg-gray-200 focus:outline-none focus:bg-white focus:border-gray-300 text-gray-900 rounded-lg pl-10 pr-4 py-2" type="text" name="search" id="search" placeholder="Search by keywords" />
    </div>
    <div className="sm:flex sm:items-center">
      ...
      <div className="relative px-5 py-5 sm:py-0 sm:ml-4 sm:px-0">
        <div className="flex items-center sm:hidden">
          <img className="h-10 w-10 object-cover rounded-full border-2 border-gray-600"
            src="https://images.unsplash.com/photo-1487412720507-e7ab37603c6f?ixlib=rb-1.2.1&ixid=eyJhcHBfaWQiOjEyMDd9&auto=format&fit=crop&w=256&q=80" alt="avatar" />
        ...
        <Dropdown className="hidden sm:block"
          ...
          trigger={<span className="block h-8 w-8 overflow-hidden rounded-full border-2 border-white xl:border-indigo-500">
            <img className="h-full w-full object-cover" src="https://images.unsplash.com/photo-1487412720507-e7ab37603c6f?ixlib=rb-1.2.1&ixid=eyJhcHBfaWQiOjEyMDd9&auto=format&fit=crop&w=256&q=80" alt="avatar" />
          </span>}
        />
      </div>
    </div>
