...
export default class Acl implements AclInterface {
    ...
    public addRole(
        ...
        parents: RoleInterface | string | string[] | null = null
    ) {
        let genericRole:any = null;
    ...
    public addResource(
        ...
        parent: ResourceInterface | string|null = null
    ): Acl {
     ...
     */
    public allow(
        roles: RoleInterface | string | Array<RoleInterface | string> | null = null,
        resources:
            | ResourceInterface
            | string
            | Array<ResourceInterface | string> | null = null,
        privileges: string | string[] | null = null
    ): Acl | null {
        return this.setRule(
            OPERATION.ADD,
            TYPE.ALLOW,
    ...
    public setRule(
        operation: OPERATION,
        type: TYPE,
        pRoles: RoleInterface | string | Array<RoleInterface | string> | null = null,
        pResources:
            | ResourceInterface
            | string
            | Array<ResourceInterface | string> | null = null,
        pPrivileges: string | string[] | null
    ): Acl | null {
    ...
    public isAllowed(
        ...
        if (true||resource !== null) {//Ivan: added true ||
            allowedResource =
    ...
    protected roleDFSVisitOnePrivilege(
        ...
        const ruleTypeOnePrivilege: TYPE | null = this.getRuleType(
            resource,
            role,
            privilege
        );
        if (ruleTypeOnePrivilege !== null) {
            ...
            const ruleTypeAllPrivileges: TYPE | null = this.getRuleType(
                resource,
                role,
                null
            );
